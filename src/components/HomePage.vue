<template>
    <div class="container">
        ...
        <div class="number-tab">
            <!-- Number tab wrapper -->
            <div class="number-tab-wrapper">
                <!-- Number tab Inner -->
                <div class="number-tab-inner">
                    <!-- Number Tab Icon -->
                    <div class="number-tab-icn-box">
                        <div class="number-tab-icn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path d="M16 11c0 2.209-1.791 4-4 4s-4-1.791-4-4v-7c0-2.209 1.791-4 4-4s4 1.791 4 4v7zm4-2v2c0 4.418-3.582 8-8 8s-8-3.582-8-8v-2h2v2c0 3.309 2.691 6 6 6s6-2.691 6-6v-2h2zm-7 13v-2h-2v2h-4v2h10v-2h-4z"/>
                            </svg>
                        </div>
                        <!-- Language selector -->
                        <div class="number-tab-lang-box">
                            <div class="number-tab-lang">
                                English
                            </div>
                        </div>
                        <!-- /end of Language selector -->
                        <div class="number-tab-dropdown">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24">
                                <path d="M12 21l-12-18h24z"/>
                            </svg>
                        </div>
                        <div class="number-tab-link">
                            |
                        </div>
                        <div class="number-tab-num-box">
                            <div class="number-tab-num-txt">
                        ...
                        <!-- /end of Number tab number box -->
                    </div>
                    <!-- /end of Number Tab Icon -->
                ...
                <!-- /end of Number tab Inner -->
            </div>
            <!-- /end of Number tab wrapper -->
        </div>
        <!-- /end of Number tab -->
        ...
        <!-- Stats Start -->
        <div class="stats-3">Stats right</div>
        <!-- /end of Stats Start-->
